...
#======= pre-processing ========
#eg.cubic_pre()   # uncoment during preprocessing and comment during post processing
...
#======= post-processing =======
#C=constants.cubic_post() # uncoment during postprocessing and comment during pre-processing
