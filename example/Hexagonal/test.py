...
#======= pre-processing ========
#eg.hexagonal_pre()   # uncoment during preprocessing and comment during post processing
...
#======= post-processing =======
#C=constants.hexagonal_post() # uncoment during postprocessing and comment during pre-processing
